...
Route::prefix('admin')->middleware(Administrator::class)->group(function () {
    ...
    // Use POST METHOD here to update a profile 
    Route::post('/profiles/{id}', [AdminController::class, "updateProfile"])->name('patch.profiles')->where('id', '[0-9]+');
